...
import com.jerryjin.fastandroid.utility.io.StreamUtil;
...
public final class PictureCompressor {
    private PictureCompressor() {
    ...
    public static File loadWithGlideCache(String path) {
        ...
        try {
            ...
            Log.d("PictureCompressor", "loadWithGlideCache:" + absPath);
            return tmp;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
